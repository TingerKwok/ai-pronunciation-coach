      ...
      categories: [
        {
          ...
          items: [
            { text: '/p/', ipa: '/p/', exampleWord: 'pen', speakableText: 'p' },
            { text: '/t/', ipa: '/t/', exampleWord: 'tea', speakableText: 't' },
            { text: '/k/', ipa: '/k/', exampleWord: 'cat', speakableText: 'k' },
            { text: '/f/', ipa: '/f/', exampleWord: 'fan', speakableText: 'f' },
            { text: '/s/', ipa: '/s/', exampleWord: 'see', speakableText: 'sss' },
            { text: '/ʃ/', ipa: '/ʃ/', exampleWord: 'she', speakableText: 'sh' },
            { text: '/θ/', ipa: '/θ/', exampleWord: 'think', speakableText: 'th' },
            { text: '/h/', ipa: '/h/', exampleWord: 'hot', speakableText: 'h' },
        ...
        },
        {
          ...
          items: [
            { text: '/b/', ipa: '/b/', exampleWord: 'bad', speakableText: 'b' },
            { text: '/d/', ipa: '/d/', exampleWord: 'did', speakableText: 'd' },
            { text: '/g/', ipa: '/g/', exampleWord: 'go', speakableText: 'g' },
            { text: '/v/', ipa: '/v/', exampleWord: 'van', speakableText: 'v' },
            { text: '/z/', ipa: '/z/', exampleWord: 'zoo', speakableText: 'z' },
            { text: '/ʒ/', ipa: '/ʒ/', exampleWord: 'vision', speakableText: 'zh' },
            { text: '/ð/', ipa: '/ð/', exampleWord: 'this', speakableText: 'th' },
            { text: '/r/', ipa: '/r/', exampleWord: 'red', speakableText: 'r' },
            ...
            { text: '/m/', ipa: '/m/', exampleWord: 'man', speakableText: 'm' },
            { text: '/n/', ipa: '/n/', exampleWord: 'no', speakableText: 'n' },
            { text: '/ŋ/', ipa: '/ŋ/', exampleWord: 'sing', speakableText: 'ng' },
            { text: '/l/', ipa: '/l/', exampleWord: 'leg', speakableText: 'l' },
